...
"GenericBrand",
1716388744191,
1716388744191);let o_microscope_brand__Olympus = new O_microscope_brand(2,
"Olympus",
1716388744191,
1716388744191);let o_microscope_brand__Bresser = new O_microscope_brand(3,
"Bresser",
1716388744191,
1716388744191);let o_microscope_brand__Nikon = new O_microscope_brand(4,
"Nikon",
1716388744191,
1716388744191);let o_microscope_brand__Zeiss = new O_microscope_brand(5,
"Zeiss",
1716388744191,
1716388744191);let o_microscope_brand__Leica = new O_microscope_brand(6,
"Leica",
1716388744191,
1716388744191);let o_microscope_objective__4x_Objective = new O_microscope_objective(1,
"4x Objective",
4,
0.1,
1,
...
"160mm",
1716388744191,
1716388744191);let o_microscope_objective__10x_Objective = new O_microscope_objective(2,
"10x Objective",
10,
0.25,
1,
...
"160mm",
1716388744191,
1716388744191);let o_microscope_objective__20x_Objective = new O_microscope_objective(3,
"20x Objective",
20,
0.4,
1,
...
"160mm",
1716388744191,
1716388744191);let o_microscope_objective__40x_Objective = new O_microscope_objective(4,
"40x Objective",
40,
0.65,
1,
...
"160mm",
1716388744191,
1716388744191);let o_microscope__ModelX = new O_microscope(1,
"ModelX",
1,
1716388744191);let o_input_action__move_slide_x_plus = new O_input_action(1,
"move_slide_x_plus",
"Slide right",
...
"Slide down (one-step)",
"Moves the slide a single step of the stepper motor, which translates to approximately 2r*pi/(number_of_steps_per_rotation) = 0.007 millimeter");let o_input_action__keep_hold_down_toggle_camera_control = new O_input_action(11,
"keep_hold_down_toggle_camera_control",
"Shift to layer 2",
"hold to to temporarily switch to a new layer");let o_input_action__keep_hold_down_toggle_image_control = new O_input_action(12,
