...
let f_update_a_o_camera = async function(){
  ...
  for(let o_device of a_o_device){
    ...
    o_state.a_o_camera.push(o_camera)
    ...
    try {
      ...
      .map(s=>{
        return new O_video_capability(
          s, 
          o_s_name_o_capability.min, 
          o_s_name_o_capability.max, 
          o_s_name_o_capability.step, 
        ) 
      })
      ...
      for (const o_resolution of a_o_resolution) {
        ...
        try {
          ...
          console.log(`o_resolution: ${JSON.stringify(o_resolution)} not available for this device`)
          console.error(error)
...
let f_try_start_webcam = async function(){
  ...
  //     video: {
  //       deviceId: {
  //         exact: o_state.o_config.o_camera.s_deviceId
  //       },
  //       width: 1920,
  //       height: 1080
  //     }
