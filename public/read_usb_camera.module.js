...
let f_keydown_or_keyup = function(o_e, b_down){
  ...
  // tmp 
  if(v_o.s_name == 'Escape' && v_o.b_down && v_o.b_down_last == false){
    // console.log('asdf')
        ...
        if (
          ...
          if(!b_remap_input_action){
            ...
            if(o_state.o_config.b_layer_switch_type_on_click_cycle_through){
              ...
              let o_input_action_mapping__prev_action_layer = o_state.o_config.a_o_input_action_mapping__layer_switch.find(o=>
                o.o_input_action==o_input_action__prev_action_layer
              )
              let v_o_input_sensor__o_input_action_mapping__next_action_layer__last = null;
              let v_o_input_sensor__o_input_action_mapping__next_action_layer = o_state?.v_o_input_device?.a_o_input_sensor?.find(
                (o, n_idx)=>{
                  if(o.s_name == o_input_action_mapping__next_action_layer?.s_name_input__controller){
                    v_o_input_sensor__o_input_action_mapping__next_action_layer__last = o_state?.v_o_input_device__last?.a_o_input_sensor[n_idx];
                    return true
                  }
                }
              )
              let v_o_input_sensor__o_input_action_mapping__prev_action_layer__last = null;
              let v_o_input_sensor__o_input_action_mapping__prev_action_layer = o_state?.v_o_input_device?.a_o_input_sensor?.find(
                (o, n_idx)=>{
                  if(o.s_name == o_input_action_mapping__prev_action_layer?.s_name_input__controller){
                    v_o_input_sensor__o_input_action_mapping__prev_action_layer__last = o_state?.v_o_input_device__last?.a_o_input_sensor[n_idx];
                    return true
                  }
                }
              );
              let v_o_keyboard_key__o_input_action_mapping__prev_action_layer = o_state.a_o_keyboard_key.find(o=>o.s_name == o_input_action_mapping__next_action_layer?.s_name_char_keyboard)
              let v_o_keyboard_key__o_input_action_mapping__next_action_layer = o_state.a_o_keyboard_key.find(o=>o.s_name == o_input_action_mapping__prev_action_layer?.s_name_char_keyboard)
              let b_next = (v_o_input_sensor__o_input_action_mapping__next_action_layer?.n_nor > 0 || v_o_keyboard_key__o_input_action_mapping__next_action_layer?.b_down);
              let b_next__last = (v_o_input_sensor__o_input_action_mapping__next_action_layer__last?.n_nor > 0 || v_o_keyboard_key__o_input_action_mapping__next_action_layer?.b_down_last);
              let b_prev = (v_o_input_sensor__o_input_action_mapping__prev_action_layer?.n_nor > 0 || v_o_keyboard_key__o_input_action_mapping__prev_action_layer?.b_down);
              let b_prev__last = (v_o_input_sensor__o_input_action_mapping__prev_action_layer__last?.n_nor > 0 || v_o_keyboard_key__o_input_action_mapping__prev_action_layer?.b_down_last);
              let n_summand = (
                b_next && !b_next__last
              ) ? 1 :
              (
              ...
              0;
                console.log({v_o_keyboard_key__o_input_action_mapping__prev_action_layer})
              ...
              let o_input_action_mapping__keep_hold_down_toggle_layer3 = o_state.o_config.a_o_input_action_mapping__layer_switch.find(o=>
                o.o_input_action==o_input_action__keep_hold_down_toggle_layer3
              )
              let v_o_input_sensor__o_input_action_mapping__keep_hold_down_toggle_layer2__last = null;
              let v_o_input_sensor__o_input_action_mapping__keep_hold_down_toggle_layer2 = o_state?.v_o_input_device?.a_o_input_sensor?.find(
                (o, n_idx)=>{
                  if(o.s_name == o_input_action_mapping__keep_hold_down_toggle_layer2?.s_name_input__controller){
                    v_o_input_sensor__o_input_action_mapping__keep_hold_down_toggle_layer2__last = o_state?.v_o_input_device__last?.a_o_input_sensor[n_idx];
                    return true
                  }
                }
              )
              let v_o_input_sensor__o_input_action_mapping__keep_hold_down_toggle_layer3__last = null;
              let v_o_input_sensor__o_input_action_mapping__keep_hold_down_toggle_layer3 = o_state?.v_o_input_device?.a_o_input_sensor?.find(
                (o, n_idx)=>{
                  if(o.s_name == o_input_action_mapping__keep_hold_down_toggle_layer3?.s_name_input__controller){
                    v_o_input_sensor__o_input_action_mapping__keep_hold_down_toggle_layer3__last = o_state?.v_o_input_device__last?.a_o_input_sensor[n_idx];
                    return true
                  }
                }
              );
