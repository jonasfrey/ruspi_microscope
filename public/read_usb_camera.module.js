...
import * as o_mod_autogenerated from './autogenerated.gitignored.module.js'
...
} from "./autogenerated.gitignored.module.js"
...
let f_s_resolution = function(o_resolution){
  return `${o_resolution.n_scl_x_px} x ${o_resolution.n_scl_y_px}`
}
...
//  b_development: true,
 ...
 o_config__default: {
   ...
   a_o_action_layer: [
     ...
     {
       v_o_input_action: null,
       s_name: 'camera control',
       a_o_input_action_mapping: [
        new O_input_action_mapping(
          o_mod_autogenerated.o_input_action__usb_camera_next, 
         o_mod_autogenerated.s_name_o_input_sensor__right_middle_finger_button_r2, 
         'o', 
          false,
        ),
        new O_input_action_mapping(
          o_mod_autogenerated.o_input_action__usb_camera_previous, 
         o_mod_autogenerated.s_name_o_input_sensor__left_middle_finger_button_l2, 
         'u', 
          false,
        ),
        new O_input_action_mapping(
          o_mod_autogenerated.o_input_action__usb_camera_resolution_next, 
         o_mod_autogenerated.s_name_o_input_sensor__direction_pad_left, 
         'j', 
          false,
        ),
        new O_input_action_mapping(
          o_mod_autogenerated.o_input_action__usb_camera_resolution_previous, 
         o_mod_autogenerated.s_name_o_input_sensor__direction_pad_right, 
         'l', 
          false,
        ),
        new O_input_action_mapping(
          o_mod_autogenerated.o_input_action__usb_camera_exposureTime_minus, 
         o_mod_autogenerated.s_name_o_input_sensor__face_button_left, 
         'a', 
          false,
        ),
        ...
        new O_input_action_mapping(
          o_mod_autogenerated.o_input_action__usb_camera_exposureMode_next, 
         o_mod_autogenerated.s_name_o_input_sensor__face_button_top, 
         'w', 
          false,
        ),
        new O_input_action_mapping(
          o_mod_autogenerated.o_input_action__usb_camera_exposureMode_previous, 
         o_mod_autogenerated.s_name_o_input_sensor__face_button_bottom, 
         's', 
          false,
        ),
        new O_input_action_mapping(
          o_mod_autogenerated.o_input_action__usb_camera_whiteBalanceMode_next, 
         o_mod_autogenerated.s_name_o_input_sensor__left_stick_button_l3, 
         'n', 
          false,
        ),
        new O_input_action_mapping(
          o_mod_autogenerated.o_input_action__usb_camera_whiteBalanceMode_previous, 
         o_mod_autogenerated.s_name_o_input_sensor__left_stick_button_l3, 
         'm', 
          false,
        ),
...
f_add_css(
  ...
  .o_video_capability:nth-child(odd) {
    background-color: rgba(22,22,22,0.9) !important;
    background-color: #1e1e1e; /* Dark background for odd items */
  }
  .o_video_capability:nth-child(even) {
    background-color: rgba(44,44,44,0.9) !important;
    background-color: #2e2e2e; /* Slightly brighter background for even items */
  }
  .info_tmp_text{
    background-color: rgba(33,33,33,0.9) !important;
    padding: 1rem;
...
if(!o_el_vid){
  ...
  // Trigger reflow, video iamge does not show when a new getUserMedia stream is used as srcObject
  o_el_vid.onloadedmetadata = function() {
    o_el_vid.style.width = o_el_vid.videoWidth + "px";
    o_el_vid.style.height = o_el_vid.videoHeight + "px";
    o_el_vid.style.width = "";
    o_el_vid.style.height = "";
    f_resize_canvas()
  };
...
let f_update_a_o_camera = async function(){
  ...
  for(let o_device of a_o_device){
    ...
    let o_camera_existing = o_state.o_config.a_o_camera.find(o=>
      o.s_deviceId == o_camera.s_deviceId
    );
    ...
    try {
      ...
      if(typeof o_state.o_video_track.getCapabilities != 'function'){
        let o_notification_tmp = f_o_throw_notification(o_state.o_state__notifire,`Please use Chromium browser to have full control over the webcams!`, 'error');
      }else{
        ...
        .map(s=>{
          ...
          let b_is_array = Array.isArray(o_cap)
          let o = new O_video_capability(
            s, 
            o_cap.min, 
            o_cap.max, 
            o_cap.step, 
            (b_is_array) ? o_cap : null,
            (b_is_array)? null: o_cap.min,
            (b_is_array) ? 0 : null,
          ) 
...
let f_update_media_stream_from_o_constraints = async function(
  o_constraints
){
  ...
  o_state.o_video_track = o_state.o_user_media_stream.getTracks()[0]
...
let f_update_n_idx_a_o_camera = async function(
  ...
  let o_noti_tmp = await f_o_throw_notification(
      o_state.o_state__notifire,
      `Switching to camera: ${o_state.o_config.a_o_camera[n_idx_a_o_camera].s_label}`,
      'loading'
    )
  ...
  o_state.o_resolution = o_resolution
  // update camera notification 
  await f_update_media_stream_from_o_constraints(
      {
        video: {
          deviceId: {
  ...
  await f_clear_o_notification(o_noti_tmp);
  await f_o_throw_notification(
    o_state.o_state__notifire,
    `Switched to camera: ${o_state.o_config.a_o_camera[o_state.o_config.n_idx_a_o_camera].s_label}`,
    'success'
  )
  await o_state?.o_js__o_camera?._f_render?.();

}
let f_update_n_idx_a_o_resolution = async function(
  n_summand
){
  let o_camera = o_state.o_config.a_o_camera[o_state.o_config.n_idx_a_o_camera];
  o_camera.n_idx_a_o_resolution = f_n_idx_ensured_inside_array(o_camera.n_idx_a_o_resolution+n_summand, o_camera.a_o_resolution.length)
  let o_resolution = o_camera.a_o_resolution[o_camera.n_idx_a_o_resolution];
  o_state.o_resolution = o_resolution
  // update camera notification 
  await f_update_media_stream_from_o_constraints(
      {
          ...
          if(!b_remap_input_action){
            ...
            for(let o_input_action_mapping of a_o_action_layer.a_o_input_action_mapping){
              let o_input_action = o_input_action_mapping.o_input_action;
                ...
                if(
                  o_input_action.s_name.startsWith('usb_camera')
                  && 
                  !o_input_action.s_name.startsWith('usb_camera_resolution')
                ){

                  if(
                    b_down && !b_down__last && !o_state.b_render__settings
                  ){
                    // let a_s = 'o_input_action__usb_camera_exposureMode_previous'.split('_');
                    let a_s = o_input_action.s_name.split('_');
                    let s_name_video_capability = a_s.at(-2);
                    let s_name_nextprev_or_plusmin = a_s.pop();
                    let o_video_capability = o_state.o_camera.a_o_video_capability.find(o=>{
                      return o.s_name == s_name_video_capability
                    });
                    let o_constraints = {
                      video: {
                        advanced: {}
                    ...
                    if(s_name_nextprev_or_plusmin == 'plus'){
                      o_video_capability.v_n = Math.max(
                        o_video_capability.v_n
                        + o_video_capability.v_n_step,
                        o_video_capability.v_n_max
                      )
                      o_constraints[s_name_file_config] = {exact: o_video_capability.v_n}
                    }
                    if(s_name_nextprev_or_plusmin == 'minus'){
                      o_video_capability.v_n = Math.min(
                        o_video_capability.v_n
                        - o_video_capability.v_n_step,
                        o_video_capability.v_n_min
                      )
                      o_constraints[s_name_file_config] = {exact: o_video_capability.v_n}
                    }
                    if(s_name_nextprev_or_plusmin == 'previous'){
                      o_video_capability.v_n_idx_a_v_option = f_n_idx_ensured_inside_array(
                        o_video_capability.v_n_idx_a_v_option -1,
                        o_video_capability.v_a_v_option.length
                      )
                      o_constraints[s_name_file_config] = {exact: o_video_capability.v_n}

                    }
                    if(s_name_nextprev_or_plusmin == 'next'){
                      o_video_capability.v_n_idx_a_v_option = f_n_idx_ensured_inside_array(
                        o_video_capability.v_n_idx_a_v_option +1,
                        o_video_capability.v_a_v_option.length
                      )
                    ...
                    o_state.o_video_track.applyConstraints(

                      {
                        // audio: false,
                        video: {
                          [s_name_video_capability]: (
                            o_video_capability.v_a_v_option
                          ) 
                          ? o_video_capability.v_a_v_option[o_video_capability.v_n_idx_a_v_option]
                          : o_video_capability.v_n
                          // deviceId: { exact: o_camera.s_deviceId },
                          // width: { exact: o_resolution.n_scl_x_px },
                          // height: { exact: o_resolution.n_scl_y_px }
                ...
                if(o_input_action.s_name == o_mod_autogenerated.o_input_action__usb_camera_next.s_name){
                  if(
                    b_down && !b_down__last && !o_state.b_render__settings
                  ){
                      f_update_n_idx_a_o_camera(1).then(()=>{
                        s_overlay_info_tmp_text += [
                        o_input_action.s_name, 
                        `active camera is : ${o_state.o_config.a_o_camera[o_state.o_config.n_idx_a_o_camera]}'`
                      ].join('\n')
                      })
                  }
                }

                if(o_input_action.s_name == o_mod_autogenerated.o_input_action__usb_camera_previous.s_name){
                  if(
                    b_down && !b_down__last && !o_state.b_render__settings
                  ){
                      f_update_n_idx_a_o_camera(-1)
                  }
                }
                ...
                if(o_input_action.s_name == o_mod_autogenerated.o_input_action__usb_camera_resolution_next.s_name){
                  if(
                    b_down && !b_down__last && !o_state.b_render__settings
                  ){
                      f_update_n_idx_a_o_resolution(-1)
                  }
                }

                if(o_input_action.s_name == o_mod_autogenerated.o_input_action__usb_camera_resolution_previous.s_name){
                  if(
                    b_down && !b_down__last && !o_state.b_render__settings
                  ){
                      f_update_n_idx_a_o_resolution(1)
                  ...
                  f_o_jsh:()=>{
                    ...
                    return {
                      ...
                      a_o: [
                        ...
                        {
                          innerText: o_state?.o_camera?.s_label
                        }, 
                        [
                          ...o_state.o_camera?.a_o_video_capability, 
                          {s_name: 'resolution', v_n: f_s_resolution(o_state.o_resolution)},
                        ]
                        .map(o_video_capability=>{
                          return {
                            class : "o_video_capability",
                            a_o: [
                              {
                                innerText: o_video_capability.s_name
                              },
                              {
                                innerText: (o_video_capability?.v_a_v_option)
                                ? o_video_capability.v_a_v_option[o_video_capability?.v_n_idx_a_v_option]
                                : o_video_capability.v_n
                              }
                            ]
