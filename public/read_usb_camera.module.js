              ...
              let o_input_action = o_input_action_mapping.o_input_action;
                ...
                if(o_input_action.s_name == o_mod_autogenerated.o_input_action__move_digital_x_plus.s_name){
                  ...
                  if(o_input_action.s_name == o_mod_autogenerated.o_input_action__reset_image_manipulation .s_name){
                    ...
                    o_state.n_factor_brightness = 1.
                    o_state.n_factor_contrast = 1.
                    o_state.n_factor_gamma = 1.0// i assume the js webcam capturing api already does gamma correction
                    o_state.n_x_trn_nor = 0.
                    o_state.n_y_trn_nor = 0.
                    s_overlay_info_tmp_text += [
                ...
                if(o_input_action.s_name == o_mod_autogenerated.o_input_action__next_image_mode.s_name){
                  if(
                    ...
                    let s = o_state.a_s_image_mode[o_state.n_idx_a_s_image_mode]
                    s_overlay_info_tmp_text += [
                      o_input_action.s_name, 
                      `'${s}'`
                    ].join('\n')
                                        ...
                                        a_o: [
                                          ...
                                          }, 
                                          {
                                            ...
                                            a_o: [
                                              {
                                                class: 'keyboard_char',
                                                innerText: (o_state.o_config?.o_input_action_mapping?.s_name == o_input_action_mapping.s_name ) ? '?': o_input_action_mapping.s_name_char_keyboard.toUpperCase()
                                              },
                                              {
                                                class: f_s_class__from_s_name_font(v_o_input_font?.s_name_font),
                                                innerText: (o_state.o_config.o_input_action?.s_name == o_input_action_mapping.s_name ) ? '?':  v_o_input_font?.s_char
                                              }, 
                                              {
                                                s_tag: "button", 
