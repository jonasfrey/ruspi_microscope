...
pub fn f_a_o_input_device() -> Vec<O_input_device> {

    let o_input_device__shenzhen_shanwan_android_gamepad : O_input_device = O_input_device {
    ...
    let o_input_device__xbox360_controller : O_input_device = O_input_device {
    ...
    return vec![
        o_input_device__shenzhen_shanwan_android_gamepad, 
