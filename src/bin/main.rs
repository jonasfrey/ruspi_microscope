...
fn f_autogenerate_js(
    ...
    let s_path = "./public/autogenerated.module.js";
                            ...
                            if(s_name_function == "f_save_screenshot"){
                                ...
                                if let Some(s_data_url) = v_json_parsed.get("s_data_url").and_then(|v| v.as_str()) {
                                    ...
                                    if let Some(s_name_file) = v_json_parsed.get("s_name_file").and_then(|v| v.as_str()) {
                                        ...
                                        let mut s_path_rel_file = String::from(s_name_file);
                                        if(s_mime_type == "image/png"){
                                            s_path_rel_file = format!("{}{}", s_name_file, ".png");
                                        }
                                        if(s_mime_type == "image/jpeg"){
                                            s_path_rel_file = format!("{}{}", s_name_file, ".jpeg");
                                        }
                                        if(s_mime_type == "image/jpg"){
                                            s_path_rel_file = format!("{}{}", s_name_file, ".jpg");
                                        }
