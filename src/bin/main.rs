...
mod autogenerated;
// Use the struct from the module
use crate::autogenerated::O_microscope_brand;
                ...
                if let Ok(v_json_parsed) = serde_json::from_str::<serde_json::Value>(text) {
                    ...
                    if let Some(s_name_function) = v_json_parsed.get("s_name_function").and_then(|v: &serde_json::Value| v.as_str()) {
                        ...
                        if let Some(s_uuid) = v_json_parsed.get("s_uuid").and_then(|v: &serde_json::Value| v.as_str()) {
                            ...
                            if(s_name_function == *autogenerated::s_name_ws_action__hello){
                                o_response.insert("s_res".to_string(), json!("World !"));
                                o_response.insert("o_child".to_string(), json!({ "s_stdout__lsusb": "yes" }));
                            }
                            if(s_name_function == *autogenerated::s_name_ws_action__f_save_screenshot ){
                            ...
                            if(s_name_function == *autogenerated::s_name_ws_action__f_add_image_to_focus_stack){
                            ...
                            if(s_name_function == *autogenerated::s_name_ws_action__f_create_focus_stack){
                                let s_config_json: String = fs::read_to_string(s_path_rel_file__config).expect("Unable to read the file");
                                // Parse the JSON data as serde_json::Value
                                let v2: Value = serde_json::from_str(&s_config_json).unwrap();
                            ...
                            if(s_name_function == *autogenerated::s_name_ws_action__f_add_iamge_to_image_stitch){
                            ...
                            if(s_name_function == *autogenerated::s_name_ws_action__f_update_image_stitching_result){
                                let s_config_json: String = fs::read_to_string(s_path_rel_file__config).expect("Unable to read the file");
                                let v_config: Value = serde_json::from_str(&s_config_json).unwrap();
                            ...
                            if(s_name_function == *autogenerated::s_name_ws_action__f_s_read_text_file ){
                                o_response.insert("s_text".to_string(), json!(f_s_read_text_file(
                                    v_json_parsed["s_path_rel"].as_str().unwrap(),
                                )));
                            }
                            if(s_name_function == *autogenerated::s_name_ws_action__f_b_write_s_text_file){
                            ...
                            if(s_name_function == *autogenerated::s_name_ws_action__f_o_command){
                        ...
                        if(s_name_function == *autogenerated::s_name_ws_action__f_control_stepper_motor){
                        ...
                        if(s_name_function == *autogenerated::s_name_ws_action__f_switch_usb_device){
